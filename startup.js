...
RATE_LIMIT_MAX_REQUESTS=100`;
  ...
  try {
    ...
    console.log('⚠️  Please update the .env file with your actual credentials before starting the application\n');
  } catch (error) {
    console.log('❌ Failed to create .env file:', error.message);
    console.log('Please create a .env file manually. See CONFIGURATION.md for details.\n');
  }
} else {
...
try {
  ...
  console.log('⚠️  Could not check MongoDB connection. Please ensure MongoDB is running.\n');
  startApplication();
}
