...
router.post('/', [
  ...
  body('description')
    ...
    .withMessage('Campaign description must be between 20 and 2000 characters'),
  body('category')
    .isIn(['building', 'missionary', 'charity', 'equipment', 'event', 'general', 'other'])
...
// @access  Private (Church Admin)
router.post('/:id/images/:filename/primary', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(DonationCampaign),
