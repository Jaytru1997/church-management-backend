...
router.post('/', [
  ...
  body('category')
    .isIn(['worship', 'ushering', 'technical', 'children', 'youth', 'outreach', 'administration', 'maintenance', 'other'])
...
router.get('/', [
  protect,
], volunteerTeamController.getAllVolunteerTeams);
...
// @access  Private (Church Members)
router.put('/:id/schedule/:scheduleId', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(VolunteerTeam),
  sanitizeInput,
...
// @access  Private (Church Members)
router.post('/:id/schedule/:scheduleId/assign', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(VolunteerTeam),
  sanitizeInput,
...
// @access  Private (Church Members)
router.put('/:id/schedule/:scheduleId/assignments/:assignmentId', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(VolunteerTeam),
  sanitizeInput,
...
// @access  Private (Church Members)
router.delete('/:id/schedule/:scheduleId/assignments/:assignmentId', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(VolunteerTeam),
...
// @access  Private (Church Members)
router.get('/upcoming-schedules/church/:churchId', [
  protect,
  checkChurchAccess,
...
// @access  Private (Church Members)
router.get('/today-schedules/church/:churchId', [
  protect,
  checkChurchAccess,
