...
router.post(
  ...
  [
    ...
    body("message")
      ...
      .withMessage(
        "Notification message must be between 10 and 1000 characters"
      ),
    body("recipients")
      .isArray({ min: 1 })
  ...
  notificationController.sendNotificationHandler
);
...
router.post(
  ...
  notificationController.sendChurchNotificationHandler
);
...
router.post(
  ...
  notificationController.sendUserNotificationHandler
);
...
router.post(
  ...
  notificationController.sendTeamNotificationHandler
);
...
router.get(
  ...
  notificationController.getNotificationsByChurch
);
...
router.post(
  ...
  notificationController.sendNotificationUsingTemplate
);
