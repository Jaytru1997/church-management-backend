...
// @access  Public
router.get("/:id", [validateObjectId("id")], churchController.getChurchById);
...
router.post(
  ...
  [
    ...
    body("time").trim().notEmpty().withMessage("Service time is required"),
    body("description")
      .optional()
      .trim()
      .isLength({ max: 200 })
...
// @access  Private (Church Admin)
router.put(
  "/:id/donation-categories/:categoryId",
  [
    protect,
    checkChurchAccess,
    sanitizeInput,
