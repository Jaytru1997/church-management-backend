...
const { handleValidationErrors, sanitizeInput, validateObjectId, validateEmail, validatePhone } = require('../middleware/validation');
...
// @access  Private (Church Members)
router.post('/:id/volunteer-teams', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(Member),
  sanitizeInput,
...
// @access  Private (Church Members)
router.put('/:id/volunteer-teams/:teamId', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(Member),
  sanitizeInput,
...
// @access  Private (Church Members)
router.delete('/:id/volunteer-teams/:teamId', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(Member),
...
// @access  Private (Church Members)
router.post('/:id/first-timer/follow-up', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(Member),
  sanitizeInput,
...
// @access  Private (Church Members)
router.put('/:id/first-timer/status', [
  protect,
  validateObjectId('id'),
  checkResourceAccess(Member),
  sanitizeInput,
...
// @access  Private (Church Members)
router.get('/attendance/church/:churchId', [
  protect,
  checkChurchAccess,
...
// @access  Private (Church Members)
router.get('/volunteers/church/:churchId', [
  protect,
  checkChurchAccess,
...
// @access  Private (Church Members)
router.get('/first-timers/church/:churchId', [
  protect,
  checkChurchAccess,
